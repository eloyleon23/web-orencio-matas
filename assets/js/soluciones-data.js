...
window.SOLUCIONES_DATA = (function () {
  ...
  const problemasFrecuentes = [
    ...
    { id: 'invernar_piscina', label: 'Quiero invernar la piscina para el invierno', solutionSlug: 'invernar-piscina' },
  ...
  const areas = [
    ...
    },
    {
      ...
      ejemplos: [
        ...
        { title: 'Invernar la piscina',                 solutionSlug: 'invernar-piscina' },
  ...
  const SOLUCIONES_RESPALDO_ESTATICO = {
    ...
    'invernar-piscina': {
      slug: 'invernar-piscina',
      title: 'Cómo invernar correctamente la piscina',
      description: 'Protocolo profesional de invernación: prepara el agua con la química correcta y protege los equipos y sondas electrónicas frente al frío para que la piscina llegue a la primavera en perfecto estado.',
      category: 'piscinas', subcategory: 'Invernación',
      problem: 'invernar_piscina',
      objective: 'proteger',
      surface: 'piscina',
      difficulty: 'Media',
      estimatedTime: '2-3 horas + una dosis de refuerzo a mitad de invierno',
      result: 'Piscina protegida durante todo el invierno, con el agua y los equipos electrónicos a salvo de las heladas',
      breadcrumb: ['Centro de Soluciones', 'Piscinas', 'Invernación'],
      materials: [
        { fase: 'Medición',              familiaSugerida: 'Análisis de agua',        items: ['Tiras analíticas o analizador de pH y cloro'] },
        { fase: 'Ajuste pH',             familiaSugerida: 'Reguladores de pH',       items: ['Reductor de pH', 'Incrementador de pH'] },
        { fase: 'Cloración de choque',   familiaSugerida: 'Cloro para piscinas',     items: ['Dicloro granulado (cloro rápido)'] },
        { fase: 'Invernador',            familiaSugerida: 'Invernadores',            items: ['Invernador líquido libre de cobre y metales'] },
        { fase: 'Protección de sondas',  familiaSugerida: 'Mantenimiento de equipos', items: ['Solución de almacenamiento para sondas (o agua limpia del grifo)'] },
      ],
      receta: [
        { fase: 'Limpiar',    emoji: '🧹' },
        { fase: 'Ajustar pH', emoji: '⚖️' },
        { fase: 'Choque',     emoji: '🧪' },
        { fase: 'Invernador', emoji: '💧' },
        { fase: 'Equipos',    emoji: '🔌' },
      ],
      steps: [
        { n: 1, title: 'Esperar a la temperatura óptima', text: 'Inicia el protocolo cuando la temperatura del agua sea inferior a 15 °C (normalmente entre octubre y noviembre) — aplicar el invernador con el agua todavía caliente reduce su efectividad.', productos: [] },
        { n: 2, title: 'Limpieza exhaustiva', text: 'Limpia las paredes del vaso, recoge hojas y residuos con el recogehojas, y lava y enjuaga a fondo el filtro de arena para eliminar el biofilm acumulado durante el verano.', productos: [] },
        { n: 3, title: 'Ajustar el pH', text: 'Analiza y ajusta el pH entre 7,2 y 7,6. Un pH fuera de rango anula el efecto de los desinfectantes y puede dañar los materiales del vaso.', productos: ['Tiras analíticas o analizador de pH y cloro', 'Reductor de pH', 'Incrementador de pH'] },
        { n: 4, title: 'Cloración de choque', text: 'Añade dicloro granulado (cloro rápido) a razón de 15 g por m³ de agua, con la filtración en marcha al menos 4 horas, para eliminar hongos y bacterias latentes.', productos: ['Dicloro granulado (cloro rápido)'] },
        { n: 5, title: 'Aplicar el invernador al día siguiente', text: 'Reparte el invernador líquido por todo el perímetro con la filtración en marcha, para una mezcla homogénea. En piscinas con revestimiento de Liner, Lámina Armada, Poliéster o Fibra de Vidrio usa siempre un invernador libre de metales/cobre — el cobre puede reaccionar con el cloro y la radiación solar dejando manchas oscuras o verdosas irreversibles. Se recomienda una segunda dosis de refuerzo a mitad del invierno (enero o febrero).', productos: ['Invernador líquido libre de cobre y metales'] },
        { n: 6, title: 'Apagar el clorador salino por debajo de 10 °C', text: 'Los sistemas de cloración salina no deben funcionar con temperaturas frías: por debajo de los 10 °C la conductividad eléctrica del agua disminuye, lo que provoca un desgaste acelerado e irreversible de las placas de titanio (electrodos). Apaga el equipo o ponlo en modo invierno.', productos: [] },
        { n: 7, title: 'Conservar las sondas de pH y ORP', text: 'Son instrumentos de vidrio muy delicados que nunca deben quedarse secos ni expuestos al agua helada sin circulación. Extráelas con cuidado de sus portasondas, coloca el capuchón protector original lleno de solución de almacenamiento de electrodos (o, en su defecto, agua limpia del grifo, nunca destilada ni desmineralizada), y guárdalas en vertical en un lugar templado y seco.', productos: ['Solución de almacenamiento para sondas (o agua limpia del grifo)'] },
        { n: 8, title: 'Elegir el método de invernación', text: 'Según la zona geográfica y si la caseta técnica está expuesta a heladas extremas: la invernación ACTIVA mantiene la filtración funcionando 2-3 horas diarias en las horas más frías (de madrugada) para evitar la congelación; la invernación PASIVA apaga por completo la filtración, baja el nivel del agua, vacía las tuberías y coloca flotadores de invernación en el vaso y gizzers en los skimmers para absorber la presión del hielo.', productos: [] },
      ],
      professionalTips: [
        'En piscinas con revestimientos de Liner, Lámina Armada, Poliéster o Fibra de Vidrio, usa siempre un invernador 100% libre de metales y sulfato de cobre — el cobre puede reaccionar con el cloro y la radiación solar dejando manchas oscuras o verdosas irreversibles.',
        'La invernación pasiva ofrece mayor protección en zonas muy frías o con riesgo de heladas extremas; la activa mantiene el agua en mejores condiciones y evita malos olores donde el clima es más suave.',
        'Guarda las sondas de pH/ORP en vertical, en un lugar templado y seco de la caseta técnica — nunca tumbadas ni a la intemperie.',
      ],
      commonMistakes: [
        'Aplicar el invernador con el agua todavía caliente, sin esperar a que baje de 15 °C.',
        'Usar un invernador con cobre o metales en piscinas de Liner, Lámina Armada, Poliéster o Fibra de Vidrio.',
        'Dejar el clorador salino encendido con el agua por debajo de 10 °C.',
        'Guardar las sondas de pH/ORP secas, tumbadas, o con agua destilada/desmineralizada en el capuchón protector.',
      ...
      seo: {
        title: 'Cómo invernar la piscina paso a paso | Orencio Matas',
        description: 'Protocolo profesional de invernación de piscinas: preparación química del vaso y protección de equipos y sondas electrónicas frente al frío.',
      },
      // Infografía descargable de Orencio Matas y Hnos con el protocolo
      // completo (las dos fases, en detalle visual) — ver en grande y
      // descargar desde la propia página de la solución.
      recursoDescargable: {
        titulo: 'Protocolo profesional de invernación',
        descripcion: 'Infografía completa de Orencio Matas y Hnos con las dos fases del protocolo: preparación del vaso y equilibrio químico, y protección de equipos y sondas electrónicas.',
        miniatura: '../assets/infografias/protocolo-invernacion-piscinas-miniatura.jpg',
        imagenCompleta: '../assets/infografias/protocolo-invernacion-piscinas.png',
      },
    },
    ...
    'lacado-profesional-muebles': {
      ...
      description: 'Aplica una laca de poliuretano sobre mueble o madera con pistola, para un acabado uniforme de nivel profesional.',
      category: 'madera', subcategory: 'Lacado profesional',
      problem: 'lacar_mueble_profesional',
      objective: 'preparar',
      surface: 'madera',
      difficulty: 'Media',
      estimatedTime: '1-2 días (preparación + laca + secado)',
      ...
      materials: [
        ...
        { fase: 'Acabado',   familiaSugerida: 'Lacas de poliuretano',  items: ['Laca de poliuretano (mate o satinada)'] },
      ],
      receta: [
        { fase: 'Preparar',   emoji: '📄' },
        { fase: 'Lacar',      emoji: '✨' },
      ...
      seo: {
        ...
        description: 'Guía para aplicar una laca de poliuretano sobre mueble o madera, con pistola, a nivel profesional.',
      },
    },
