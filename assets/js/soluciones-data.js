...
window.SOLUCIONES_DATA = (function () {
  ...
  const areas = [
    ...
    },
    {
      ...
      ejemplos: [
        ...
        { title: 'Tratar un hongo en las plantas' },
      ],
    },
  ];
  ...
  function diagnosticarPorTexto(texto) {
    ...
    const coincidencias = {
      ...
      'quitar_pintura': ['decapar', 'decapante', 'quitar pintura vieja'],
      'mal_acabado':['barniz', 'blanquecino', 'burbuja', 'mueble', 'madera', 'no ha quedado bien'],
