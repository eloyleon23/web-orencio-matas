...
function crearHojaAyuda() {
  ...
  const datos = [
    ...
    ['tipologia', 'Subcategoría. Debe coincidir con la columna Familia de FamiliaProductos para respetar el orden'],
    ...
    ['', 'La hoja "FamiliaProductos" define el orden de las secciones en el catálogo'],
    ['', 'La columna "Familia" debe coincidir con la columna "tipologia" de Productos'],
    ['', 'Si una tipología no está en FamiliaProductos aparecerá al final'],
    ['', ''],
    ['CATÁLOGO ZAPHIRO', ''],
